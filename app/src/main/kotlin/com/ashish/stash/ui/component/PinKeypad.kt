        ...
        Row(horizontalArrangement = Arrangement.spacedBy(32.dp)) {
            ...
            if (onBiometricClick != null) {
                IconButton(
                    ...
                    Icon(Icons.Default.Fingerprint, contentDescription = "Biometric", tint = StashBlue, modifier = Modifier.size(36.dp))
                }
            } else {
            ...
            IconButton(
                ...
                Icon(Icons.AutoMirrored.Filled.Backspace, contentDescription = "Delete", tint = Color.Gray, modifier = Modifier.size(32.dp))
            }
        }
    }
}
