...
public final class DocumentDao_Impl implements DocumentDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateColorTag;
  ...
  public DocumentDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfDocumentEntity = new EntityInsertionAdapter<DocumentEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `documents` (`document_id`,`uri`,`display_title`,`original_filename`,`mime_type`,`file_hash`,`file_size`,`category_id`,`folder_id`,`notes`,`ocr_text`,`color_tag`,`importance`,`is_locked`,`created_at`,`last_opened_at`,`import_source`,`category_name`,`label_names`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(3, entity.getDisplayTitle());
        statement.bindString(4, entity.getOriginalFilename());
        statement.bindString(5, entity.getMimeType());
        statement.bindString(6, entity.getFileHash());
        ...
        if (entity.getFolderId() == null) {
          ...
          statement.bindLong(9, entity.getFolderId());
        }
        ...
        if (entity.getOcrText() == null) {
          ...
          statement.bindString(11, entity.getOcrText());
        }
        if (entity.getColorTag() == null) {
          statement.bindNull(12);
        } else {
          statement.bindString(12, entity.getColorTag());
        }
        statement.bindString(13, entity.getImportance());
        statement.bindLong(14, entity.isLocked());
        statement.bindLong(15, entity.getCreatedAt());
        statement.bindLong(16, entity.getLastOpenedAt());
        statement.bindString(17, entity.getImportSource());
        if (entity.getCategoryName() == null) {
          statement.bindNull(18);
        } else {
          statement.bindString(18, entity.getCategoryName());
        }
        if (entity.getLabelNames() == null) {
          statement.bindNull(19);
        } else {
          statement.bindString(19, entity.getLabelNames());
        }
      }
    };
    this.__deletionAdapterOfDocumentEntity = new EntityDeletionOrUpdateAdapter<DocumentEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "DELETE FROM `documents` WHERE `document_id` = ?";
      }
    ...
    this.__updateAdapterOfDocumentEntity = new EntityDeletionOrUpdateAdapter<DocumentEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `documents` SET `document_id` = ?,`uri` = ?,`display_title` = ?,`original_filename` = ?,`mime_type` = ?,`file_hash` = ?,`file_size` = ?,`category_id` = ?,`folder_id` = ?,`notes` = ?,`ocr_text` = ?,`color_tag` = ?,`importance` = ?,`is_locked` = ?,`created_at` = ?,`last_opened_at` = ?,`import_source` = ?,`category_name` = ?,`label_names` = ? WHERE `document_id` = ?";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(20, entity.getDocumentId());
      }
    };
    this.__preparedStmtOfUpdateLastOpened = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE documents SET last_opened_at = ? WHERE document_id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTitle = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE documents SET display_title = ? WHERE document_id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLockStatus = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE documents SET is_locked = ? WHERE document_id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateColorTag = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE documents SET color_tag = ? WHERE document_id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfDeleteById = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM documents WHERE document_id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object updateLastOpened(final long id, final long timestamp,
  ...
  @Override
  public Object updateColorTag(final long id, final String colorTag,
      final Continuation<? super Integer> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Integer>() {
      @Override
      @NonNull
      public Integer call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateColorTag.acquire();
        int _argIndex = 1;
        if (colorTag == null) {
          _stmt.bindNull(_argIndex);
        } else {
          _stmt.bindString(_argIndex, colorTag);
        }
        _argIndex = 2;
        _stmt.bindLong(_argIndex, id);
        try {
          ...
          __preparedStmtOfUpdateColorTag.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  public Object getById(final long id, final Continuation<? super DocumentEntity> $completion) {
    final String _sql = "SELECT * FROM documents WHERE document_id = ?";
      ...
      public DocumentEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new DocumentEntity(_tmpDocumentId,_tmpUri,_tmpDisplayTitle,_tmpOriginalFilename,_tmpMimeType,_tmpFileHash,_tmpFileSize,_tmpCategoryId,_tmpFolderId,_tmpNotes,_tmpOcrText,_tmpColorTag,_tmpImportance,_tmpIsLocked,_tmpCreatedAt,_tmpLastOpenedAt,_tmpImportSource,_tmpCategoryName,_tmpLabelNames);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getWithMetadataById(final long id, final int showLocked,
      final Continuation<? super DocumentWithMetadata> $completion) {
    final String _sql = "\n"
            + "        SELECT * FROM documents \n"
            + "        WHERE document_id = ? \n"
            + "        AND (? = 1 OR (is_locked = 0 AND (folder_id IS NULL OR (SELECT is_locked FROM folders WHERE folder_id = documents.folder_id) = 0)))\n"
            + "    ";
    ...
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, true, _cancellationSignal, new Callable<DocumentWithMetadata>() {
      @Override
      @Nullable
      public DocumentWithMetadata call() throws Exception {
        __db.beginTransaction();
        try {
          ...
          try {
            ...
            final DocumentWithMetadata _result;
            if (_cursor.moveToFirst()) {
              ...
              _result = new DocumentWithMetadata(_tmpDocument,_tmpCategory,_tmpFolder,_tmpLabelsCollection,_tmpResourceLinksCollection);
            } else {
              _result = null;
            }
            __db.setTransactionSuccessful();
  ...
  @Override
  public Flow<List<DocumentWithMetadata>> observeAll(final int showLocked) {
    final String _sql = "\n"
            + "        SELECT * FROM documents \n"
            + "        WHERE (? = 1 OR (is_locked = 0 AND (folder_id IS NULL OR (SELECT is_locked FROM folders WHERE folder_id = documents.folder_id) = 0)))\n"
    ...
    return CoroutinesRoom.createFlow(__db, true, new String[] {"categories", "folders",
        "document_labels", "labels", "resource_links",
        "documents"}, new Callable<List<DocumentWithMetadata>>() {
      @Override
      @NonNull
  ...
  @Override
  public Object countByHashAndSize(final String hash, final long size,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM documents WHERE file_hash = ? AND file_size = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
  ...
  @Override
  public Flow<List<DocumentWithMetadata>> observePriorityWithMetadata(final int showLocked) {
    final String _sql = "\n"
            + "        SELECT * FROM documents \n"
            + "        WHERE (? = 1 OR (is_locked = 0 AND (folder_id IS NULL OR (SELECT is_locked FROM folders WHERE folder_id = documents.folder_id) = 0)))\n"
  ...
  @Override
  public Flow<Integer> observeUnlockedCount() {
    final String _sql = "SELECT COUNT(*) FROM documents WHERE is_locked = 0";
  ...
  @Override
  public Flow<Integer> observeLockedCount() {
    final String _sql = "SELECT COUNT(*) FROM documents WHERE is_locked = 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"documents"}, new Callable<Integer>() {
      @Override
      @NonNull
  ...
  @Override
  public Flow<Long> observeTotalSizeBytes() {
    final String _sql = "SELECT SUM(file_size) FROM documents";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"documents"}, new Callable<Long>() {
      @Override
      @Nullable
      public Long call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
