  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`category_id`,`name`,`color`) VALUES (nullif(?, 0),?,?)";
      }
    ...
    this.__updateAdapterOfCategoryEntity = new EntityDeletionOrUpdateAdapter<CategoryEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `category_id` = ?,`name` = ?,`color` = ? WHERE `category_id` = ?";
      }
      ...
      public CategoryEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new CategoryEntity(_tmpCategoryId,_tmpName,_tmpColor);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpColor;
            _tmpColor = _cursor.getString(_cursorIndexOfColor);
            _item = new CategoryEntity(_tmpCategoryId,_tmpName,_tmpColor);
            _result.add(_item);
          }
          return _result;
        } finally {
