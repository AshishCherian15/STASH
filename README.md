...
**Stash** is a production-grade, privacy-first document discovery and management application for Android. Built for professionals, researchers, and security-conscious users, Stash allows you to index, organize, and search through local documents using on-device AI intelligence.
...
### 🔍 Intelligence & Search
- **Deep Full-Text Search (FTS):** Instant sub-50ms search across filenames, custom descriptions, and OCR content using SQLite FTS4.
...
- **Multi-Layer Locking:** Secure your vault behind a **4-digit PIN** (PBKDF2 hashed) or native **Biometrics** (Fingerprint/Face).
- **Dual-Level Auth:** Separate locks for the App and specific sensitive "Secure Items".
...
- **Device-Wide Indexing:** Support for **All Files Access** (on Android 11+) to search every corner of your device without duplicating files.
- **Professional Palette:** Industry-standard categories (Legal, Financial, Medical) with professional identity markers.
